...
#Find first 'by William Shakespeare'
phrase = "by William Shakespeare"
position = data.find(phrase)

print("Position: ",position)  # Placeringen af den første forekomst
print("return the text: ",data[position:position + len(phrase)])  # Selve teksten
 

#Count scene
Scences = data.count("Scene")
print("Number of Scenes: ",Scences)

#Count Hamlet
Hamlet = data.count("Hamlet")
print("Number of mentions of Hamlet: ",Hamlet)

#Count Queen of Denmark

Qdk = data.count("Queen of Denmark")
print("Number of mentions of Queen of Denmark: ",Qdk)
 

#Find and Print: 'Queen of Denmark'

phrase2 = "Queen of Denmark"
position2 = data.find(phrase)

print("position: ",position2)  # Placeringen af den første forekomst
print(data[position2:position2 + len(phrase2)])  # Selve teksten
 

#Get length of text

print("Lenght af text: ",len(data))


#Find first Hamlet
phrase3 = "Hamlet"
position3 = data.find(phrase3)

print("Position: ",position3)  # Placeringen af den første forekomst
print("return the first ocurance of Hamlet : ",data[position3:position3 + len(phrase3)])  # Selve teksten


#Get the length of text between first Hamlet and the next one. 
first = data.find("Hamlet")
second = data.find("Hamlet", first + len("Hamlet"))

length_between = second - (first + len("Hamlet"))
...
#Enter a word
searchword = input("write a word you want to find")
if data.find(searchword) == -1: # true
    print("ordet eller frasen findet ikke")
else:
  print("ordet findes") #false
